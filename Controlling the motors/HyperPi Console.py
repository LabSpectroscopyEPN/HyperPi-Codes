...
btn_set_sampler_angle = tk.Button(frm_buttons, "Move Sampler", command = lambda: set_angle(float(sampler_angle.get())), pins["Sampler"])
...
btn_set_polarizer_angle = tk.Button(frm_buttons, "Move Polarizer", command = lambda: set_angle(float(polarizer_angle.get())), pins["Polarizer"])
